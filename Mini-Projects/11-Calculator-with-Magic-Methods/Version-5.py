...
def main():
    ...
    while True:
        ...
        choice = get_choice("Enter your choice: ", 1, 9)
        ...
        if choice == 1:
            ...
            result = calc1 + calc2    # Why result.num, cuz result is Calculator object and result.num is actual number
            history.append(f"{num1} + {num2} = {result.num}")
            ...
            num1 = get_float("Enter number: ")
            num2 = get_float("Enter it's power: ")
            ...
            result = calc1 ** calc2    
            history.append(f"{num1} to the power of {num2} = {result.num}")
            ...
            if calc1 == calc2:
                ...
                result = calc1 == calc2
                history.append(f"{num1} = {num2} : {result}") # Didn't use result.num as there is a boolean value being returned 
            ...
            result = abs(calc)    
            history.append(f"Absolute value of {num} = {result}")
